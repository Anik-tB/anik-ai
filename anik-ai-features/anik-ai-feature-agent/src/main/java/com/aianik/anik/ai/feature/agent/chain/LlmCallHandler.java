...
/**
 * End point of the chain of responsibility: Assemble {@link com.aianik.anik.ai.common.dto.agent.ChatDispatchRequest} from {@link AgentChatContext} and call the remote Client via gRPC streaming.
 */
@Slf4j
@Component
@Order(80)
...
public class LlmCallHandler implements AgentChatHandler {
    ...
    public void handle(AgentChatContext ctx) {
        ...
        com.aianik.anik.ai.common.dto.agent.ChatDispatchRequest request = buildDispatchRequest(ctx);
