...
import com.aizuda.anik.ai.vector.storage.vector.api.VectorSearchRequest;
import com.aizuda.anik.ai.vector.storage.vector.api.VectorSearchResult;
...
public class VectorSearchHandler implements RagSearchHandler {
    ...
    public void handle(RagSearchContext ctx) {
        ...
        AnikAiVectorStore vectorStore = vectorStoreFactory.create(ctx.getKnowledge());
