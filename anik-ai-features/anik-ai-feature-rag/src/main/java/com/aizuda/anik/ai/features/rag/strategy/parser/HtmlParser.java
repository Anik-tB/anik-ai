...
public class HtmlParser implements DocumentParser {
    ...
    public String parse(InputStream inputStream) {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream, StandardCharsets.UTF_8))) {
            ...
            throw new AnikAiException("Failed to parse HTML", e);
        }
    }
    ...
    private String stripHtmlTags(String html) {
        ...
        // Block-level tags are replaced with line breaks, preserving paragraph structure
        ...
        // Merge excess spaces within the line, but retain line breaks
        text = text.replaceAll("[ \\t]+", " ");
        // Merge consecutive empty lines into a single newline
        text = text.replaceAll("\\n[ \\t]*\\n+", "\n\n");
        return text.trim();
    }
