package com.aizuda.anik.ai.search.storage.search.elasticsearch;
...
import com.aizuda.anik.ai.search.storage.search.api.SearchDeleteRequest;
import com.aizuda.anik.ai.search.storage.search.api.SearchEngine;
import com.aizuda.anik.ai.search.storage.search.api.SearchRequest;
...
public class ElasticsearchSearchEngine implements SearchEngine {
    ...
    public void insert(SearchAddRequest request) {
        ...
        if (indexName == null) {
            throw new SearchEngineException("SearchAddRequest.indexName cannot be empty");
        }
    ...
    public void delete(SearchDeleteRequest request) {
        ...
        String indexName = request.getIndexName();
        if (indexName == null) {
            throw new SearchEngineException("SearchDeleteRequest.indexName cannot be empty");
        }
        try {
    ...
    public static final class Builder {
        ...
        public Builder setConfig(com.aizuda.anik.ai.search.storage.search.elasticsearch.ElasticsearchVectorSettings settings) {
