package com.aizuda.anik.ai.persistence.rag.mapper;
...
public interface RagChunkMapper extends BaseMapper<RagChunkPO> {
    ...
    @Select("SELECT MAX(chunk_index) FROM anik_ai_rag_chunk WHERE document_id = #{documentId}")
