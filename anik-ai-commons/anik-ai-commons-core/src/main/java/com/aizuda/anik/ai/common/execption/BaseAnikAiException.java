package com.aizuda.anik.ai.common.execption;

import org.slf4j.helpers.MessageFormatter;

/**
 * Exception info (copied from anik-job)
 */
public class BaseAnikAiException extends RuntimeException {

    public BaseAnikAiException(String message) {
        super(message);
    }

    public BaseAnikAiException(String message, Throwable cause) {
        super(message, cause);
    }

    public BaseAnikAiException(Throwable cause) {
        super(cause);
    }

    public BaseAnikAiException(String message, Object... arguments) {
        this(message, getArguments(arguments), getThrowable(arguments));
    }

    public BaseAnikAiException(String message, Object[] arguments, Throwable cause) {
        super(MessageFormatter.arrayFormat(message, arguments).getMessage(), cause);
    }

    public BaseAnikAiException(String message, Object argument, Throwable cause) {
        super(MessageFormatter.format(message, argument).getMessage(), cause);
    }

    public BaseAnikAiException(String message, Object argument) {
