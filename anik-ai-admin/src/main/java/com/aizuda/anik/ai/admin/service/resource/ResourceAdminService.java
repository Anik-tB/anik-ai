package com.aizuda.anik.ai.admin.service.resource;

import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import com.aizuda.anik.ai.admin.vo.PageResult;
import com.aizuda.anik.ai.admin.vo.resource.ResourceQueryVO;
import com.aizuda.anik.ai.admin.vo.resource.ResourceResponseVO;
import com.aizuda.anik.ai.admin.vo.resource.ResourceUploadRequestVO;
...
public class ResourceAdminService {
    ...
    public ResourceResponseVO upload(MultipartFile file, ResourceUploadRequestVO request) {
        ...
        try {
            ...
            throw new AnikAiException("Failed to read uploaded file", e);
        }
    }
