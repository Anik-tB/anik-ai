...
import com.aianik.anik.ai.admin.vo.StoreInstanceRequestVO;
...
import com.aianik.anik.ai.admin.service.StoreInstanceService;
...
public class StoreInstanceController {
    ...
    public Result<StoreInstanceVO> get(@PathVariable("id") Long id) {
        ...
        if (vo == null) {
            return Result.fail("Storage instance does not exist");
        }
        return Result.ok(vo);
    }
