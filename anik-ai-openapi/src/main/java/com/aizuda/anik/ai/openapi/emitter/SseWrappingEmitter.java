...
/**
 * SSE packaging adapter
 * <p>
 * Call ResponseBodyEmitter.send(text) of AgentChatService
 * Convert to standard SSE event format (event + data) and output to client SDK for analysis.
 *
 * @author openanik
 * @date 2026-04-24
 */
