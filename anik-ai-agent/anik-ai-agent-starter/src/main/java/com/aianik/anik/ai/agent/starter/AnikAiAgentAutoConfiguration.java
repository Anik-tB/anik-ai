package com.aianik.anik.ai.agent.starter;

import com.aianik.anik.ai.agent.common.rpc.RpcClient;
import com.aianik.anik.ai.agent.common.rpc.GrpcClientInvokeHandler;
import com.aianik.anik.ai.agent.common.config.AnikAiAgentProperties;
import com.aianik.anik.ai.agent.common.context.AgentChatContextThreadLocalAccessor;
import com.aianik.anik.ai.agent.common.rpc.GrpcChannelProvider;
import com.aianik.anik.ai.agent.common.handler.ClientHeartbeatScheduler;
import com.aianik.anik.ai.agent.common.rpc.ClientGrpcServer;
import com.aianik.anik.ai.agent.core.ClientRequestDispatcher;
import com.aianik.anik.ai.agent.core.advisor.InterceptorChainAdvisor;
import com.aianik.anik.ai.agent.core.advisor.MemoryInjectionAdvisor;
import com.aianik.anik.ai.agent.core.advisor.StreamChunkForwarderAdvisor;
import com.aianik.anik.ai.agent.core.advisor.ThinkingCollectorAdvisor;
import com.aianik.anik.ai.agent.core.advisor.TokenUsageCollectorAdvisor;
import com.aianik.anik.ai.agent.core.executor.ClientChatExecutor;
import com.aianik.anik.ai.agent.core.grpc.handler.ChatDispatchStreamingHandler;
import com.aianik.anik.ai.agent.core.grpc.handler.PingRequestHandler;
import com.aianik.anik.ai.agent.core.interceptor.AnikAiInterceptor;
import com.aianik.anik.ai.agent.core.interceptor.impl.LoggingInterceptor;
import com.aianik.anik.ai.agent.core.resolver.ClientMemoryToolResolver;
import com.aianik.anik.ai.agent.core.resolver.ClientRagToolResolver;
import com.aianik.anik.ai.agent.core.resolver.ClientSkillToolResolver;
import com.aianik.anik.ai.agent.core.resolver.CustomToolCallbackProvider;
