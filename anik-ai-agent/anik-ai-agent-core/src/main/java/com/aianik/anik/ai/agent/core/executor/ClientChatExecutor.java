...
import com.aianik.anik.ai.agent.core.advisor.ClientAdvisorKeys;
import com.aianik.anik.ai.agent.core.advisor.ClientStreamExecutionContext;
...
/**
 * Client-side LLM execution engine: manages prompt injection, interceptor, thought chain and chunk forwarding through {@link Advisor} chain of responsibility,
 * It is only responsible for building {@link ChatClient} and streaming calls.
 */
@Slf4j
public class ClientChatExecutor {
    ...
    /**
     * Streaming execution: The Advisor chain is responsible for memory/history, interception, thinking reporting and chunk callbacks.
     */
    ...
    /**
     * Return the original response stream (text chunk forwarded by {@link com.aianik.anik.ai.agent.core.advisor.StreamChunkForwarderAdvisor}).
     */
    ...
    /**
     * Contains only original system + user; memory and history are injected by {@link com.aianik.anik.ai.agent.core.advisor.MemoryInjectionAdvisor}.
     */
    ...
    private ChatClient buildChatClient(ChatDispatchRequest.ModelConfig modelConfig, List<ToolCallback> tools) {
        ...
        OpenAiChatOptions.Builder optionsBuilder = OpenAiChatOptions.builder()
                .internalToolExecutionEnabled(true)  //✅ enable automatic tool execution and support ReAct loop
                .model(modelConfig.getModelKey())
                .streamUsage(true);  //✅ Let OpenAI API return usage in streaming final chunk
