...
public final class ClientAdvisorKeys {
    ...
    /** {@link com.aizuda.anik.ai.common.dto.agent.ChatDispatchRequest} */
    public static final String DISPATCH = "anik.dispatch";

    /** {@link com.aizuda.anik.ai.agent.common.report.ClientTraceBuffer} (optional, for interceptor use) */
