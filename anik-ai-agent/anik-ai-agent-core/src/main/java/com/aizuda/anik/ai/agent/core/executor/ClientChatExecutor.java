package com.aizuda.anik.ai.agent.core.executor;
...
import com.aizuda.anik.ai.agent.core.advisor.ClientAdvisorKeys;
import com.aizuda.anik.ai.agent.core.advisor.ClientStreamExecutionContext;
...
public class ClientChatExecutor {
    ...
    /**
     * Return the original response stream (text chunk forwarded by {@link com.aizuda.anik.ai.agent.core.advisor.StreamChunkForwarderAdvisor}).
     */
    ...
    /**
     * Contains only original system + user; memory and history are injected by {@link com.aizuda.anik.ai.agent.core.advisor.MemoryInjectionAdvisor}.
     */
